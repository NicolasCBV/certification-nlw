package com.rocketseat.certificationlw.modules.students.repositories;
...
@Repository
public interface CertificationStudentRepo extends JpaRepository<CertificationStudentEntity, UUID> {
